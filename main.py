...
# print("Importing database_operation")
# from database_operation import (
#     create_database,
#     get_absence_records,
#     get_names,
...
#         self.ui = MyGui()
#         print("MyGui instance is created")
#         self.ui.setupUi(self)
...
#         self.ui.tableWidget.clear()
#         self.ui.tableWidget.setColumnCount(11)
#         self.ui.tableWidget.setHorizontalHeaderLabels(constants['header_Title'])
#         self.ui.tableWidget.verticalHeader().setVisible(False)
#         self.ui.tableWidget.setColumnHidden(0, True)
#         self.ui.tableWidget.horizontalHeader().setSectionResizeMode(1, QHeaderView.Stretch)
#         self.ui.tableWidget.setColumnHidden(2, True)
...
#         employees_absences = {
#            constants['categorys'][0]: get_absence_records(0, month, year),
#            constants['categorys'][1]: get_absence_records(1, month, year),
#            constants['categorys'][2]: get_absence_records(2, month, year),
#            constants['categorys'][3]: get_absence_records(3, month, year),
#         }
...
#         category: int = self.ui.comboBox_category.currentIndex()
#         employees_absences = get_absence_records(category, month, year)    
#         output_docx = f"إشعارات {constants['categorys'][category]} {month + 1}-{year}.docx"
#         generate_notices(output_docx, month, year, employees_absences)

# if __name__ == "__main__":
#     print("the main function: if __name__ == __main__: is running")
#     # create_database()
